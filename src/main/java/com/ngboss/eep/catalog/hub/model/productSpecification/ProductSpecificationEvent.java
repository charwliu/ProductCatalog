package com.ngboss.eep.catalog.hub.model.productSpecification;
...
public class ProductSpecificationEvent implements Serializable {
    ...
    public String toString() {
        return "ProductSpecificationEvent{" + "id=" + id + ", eventTime=" + eventTime + ", model=" + resource + ", eventType=" + eventType + '}';
    }
}
