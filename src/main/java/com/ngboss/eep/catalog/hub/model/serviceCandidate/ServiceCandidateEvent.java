package com.ngboss.eep.catalog.hub.model.serviceCandidate;
...
public class ServiceCandidateEvent implements Serializable {
    ...
    class EventBody {
        ...
        private final ServiceCandidate serviceCandidate;
    ...
    public String toString() {
        return "ServiceCandidateEvent{" + "id=" + id + ", eventTime=" + eventTime + ", model=" + resource + ", eventType=" + eventType + '}';
    }
}
