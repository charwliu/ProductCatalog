...
import com.ngboss.eep.catalog.hub.model.catalog.CatalogEventType;
...
public class CatalogEventPublisher implements CatalogEventPublisherLocal {
     ...
     * > Add Business Method") Access Hubs using callbacks and send to http
     * publisher (pool should be configured around the RESTEventPublisher bean)
     * Loop into array of Hubs Call RestEventPublisher - Need to implement
     * resend policy plus eviction Filtering is done in RestEventPublisher based
     * on query expression
     */
    @Override
