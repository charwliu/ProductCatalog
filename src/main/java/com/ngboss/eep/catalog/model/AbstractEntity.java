...
public abstract class AbstractEntity implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!Utilities.areEqual(this.version, other.version)) {
            return false;
        }
        ...
        if (!Utilities.areEqual(this.lastUpdate, other.lastUpdate)) {
            return false;
        }
    ...
    public boolean keysMatch(AbstractEntity input) {
        ...
        if (!Utilities.areEqual(this.id, input.id)) {
            return false;
        }

        return Utilities.areEqual(this.version, input.version);
    }
    ...
    public boolean isValid() {
        ...
        if (!Utilities.hasValue(this.name)) {
            logger.log(Level.FINE, " invalid: name is required");
            return false;
        }

        if (this.validFor != null && !this.validFor.isValid()) {
