...
import com.ngboss.eep.catalog.model.specification.RequiredSpecification;
...
public class ServiceSpecification extends AbstractCatalogEntity implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!Utilities.areEqual(this.serviceSpecificationRelationship, other.serviceSpecificationRelationship)) {
            return false;
        }

        if (!Utilities.areEqual(this.requiredServiceSpecification, other.requiredServiceSpecification)) {
            return false;
        }

        if (!Utilities.areEqual(this.requiredResourceSpecification, other.requiredResourceSpecification)) {
            return false;
        }

        return Utilities.areEqual(this.serviceSpecCharacteristic, other.serviceSpecCharacteristic);
    }
    ...
    private boolean validateCharacteristics() {
        if (!Utilities.hasContents(this.serviceSpecCharacteristic)) {
            return true;
        }

        return this.serviceSpecCharacteristic.stream().noneMatch((characteristic) -> (!characteristic.isValid()));
    }
