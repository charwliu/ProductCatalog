package com.ngboss.eep.catalog.model.category;
...
public class Category extends AbstractCatalogEntity implements Serializable {
    ...
    public boolean isValid() {
        ...
        if (Objects.equals(this.isRoot, Boolean.FALSE) && !Utilities.hasValue(parentId)) {
            logger.log(Level.FINE, " invalid: parentId must be specified when isRoot is false");
            return false;
        }

        if (Objects.equals(this.isRoot, Boolean.TRUE) && parentId != null) {
