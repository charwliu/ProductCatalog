...
public class ProductOfferPriceAlteration implements Serializable {
    ...
    @Column(name = "PRICE_ALT_NAME")
    private String name;

    @Column(name = "PRICE_ALT_DESCRIPTION")
    ...
    @Column(name = "PRICE_ALT_PRICE_TYPE")
    private ProductOfferPriceAlterationType priceType;

    @Column(name = "PRICE_ALT_UNIT_OF_MEASURE")
    private String unitOfMeasure;

    @Embedded
    private AlterationPrice price;

    @Column(name = "PRICE_ALT_RECURRING_CHARGE_PERIOD")
    private String recurringChargePeriod;

    @Column(name = "PRICE_ALT_PRICE_CONDITION")
    ...
    public boolean equals(Object object) {
        ...
        if (!Utilities.areEqual(this.price, other.price)) {
            return false;
        }

        if (!Utilities.areEqual(this.recurringChargePeriod, other.recurringChargePeriod)) {
            return false;
        }

        return Utilities.areEqual(this.priceCondition, other.priceCondition);
    }
