...
import com.ngboss.eep.catalog.model.ServiceLevelAgreement;
...
public class ProductOffering extends AbstractCatalogEntity implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        return Utilities.areEqual(this.productOfferingPrice, other.productOfferingPrice) != false;
    }
    ...
    public static ProductOffering createProto() {
        ...
        productOffering.category = new ArrayList<>();
        productOffering.category.add(CatalogReference.createProto());

        productOffering.channel = new ArrayList<>();
        productOffering.channel.add(Channel.createProto());

        productOffering.place = new ArrayList<>();
        productOffering.place.add(Place.createProto());

        productOffering.bundledProductOffering = new ArrayList<>();
        ...
        productOffering.productOfferingTerm = new ArrayList<>();
        productOffering.productOfferingTerm.add(ProductOfferingTerm.createProto());

        productOffering.productOfferingPrice = new ArrayList<>();
