...
public class ResourceCandidate extends AbstractCatalogEntity implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!Utilities.areEqual(this.category, other.category)) {
            return false;
        }

        if (!Utilities.areEqual(this.serviceLevelAgreement, other.serviceLevelAgreement)) {
            return false;
        }

        return Utilities.areEqual(this.resourceSpecification, other.resourceSpecification);
    }
    ...
    public static ResourceCandidate createProto() {
        ...
        resourceCandidate.category = new ArrayList<>();
