...
public class ResourceSpecification extends AbstractCatalogEntity implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        return Utilities.areEqual(this.resourceSpecCharacteristic, other.resourceSpecCharacteristic) != false;
    }
    ...
    public boolean isValid() {
        ...
        return validateCharacteristics() != false;
    }
    ...
    public boolean validateCharacteristics() {
        ...
        return this.resourceSpecCharacteristic.stream().noneMatch((characteristic) -> (characteristic.isValid() == false));
    }
    ...
    public static ResourceSpecification createProto() {
        ...
        resourceSpecification.attachment = new ArrayList<>();
        resourceSpecification.attachment.add(Attachment.createProto());

        resourceSpecification.relatedParty = new ArrayList<>();
        resourceSpecification.relatedParty.add(RelatedParty.createProto());

        resourceSpecification.resourceSpecificationRelationship = new ArrayList<>();
        resourceSpecification.resourceSpecificationRelationship.add(SpecificationRelationship.createProto());

        resourceSpecification.resourceSpecCharacteristic = new ArrayList<>();
