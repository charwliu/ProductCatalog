...
public class QueryParameterParser {
    ...
    private final HashSet<String> tagsWithNoValue = new HashSet<>();
    private final MultivaluedHashMap<String, String> tagsWithValue = new MultivaluedHashMap<>();
    ...
    public MultivaluedMap<String, String> getTagsWithValue() {
