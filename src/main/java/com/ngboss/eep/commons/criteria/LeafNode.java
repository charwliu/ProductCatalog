...
import com.ngboss.eep.commons.ClassFields;
...
public class LeafNode extends AbstractNode {
    ...
    private final EnumMap<Operator, Operation> operations = new EnumMap<>(Operator.class);
    ...
    private void normalizeVersion() {
        operations.keySet().stream().filter((operator) -> !(operator == Operator.REG_EXP)).map((operator) -> operations.get(operator)).forEachOrdered((operation) -> {
